...
export default function Progetti() {
  return (
   ...
   <Navbar></Navbar>
   <div className="container mx-auto flex  flex-col gap-2 justify-center items-center mt-30">
  ...
  <Card2progetti  eccolo="Un'antica stalla quasi in rovina, tra pietre logore e travi marcite, rinata come la casa d relax." titolo="Cortina" testo="Casa Bianca" immagine=" bg-[url(/images/progetto4.jpg)]"/>
  </div>
   </>
  );
}
